...
\`\`\`markdown
${artifacts['VALIDATE/validation-report.md'] || 'Validation report not available (project may not have completed VALIDATE phase)'}
\`\`\`

### Coverage Matrix

\`\`\`markdown
${artifacts['VALIDATE/coverage-matrix.md'] || 'Coverage matrix not available (project may not have completed VALIDATE phase)'}
\`\`\`
