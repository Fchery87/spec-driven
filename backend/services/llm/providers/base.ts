  ...
  gemini: [
    {
      ...
      description: 'Latest frontier-class performance',
    },
    {
      id: 'gemini-2.5-flash',
    ...
    },
    {
      id: 'gemini-2.5-pro',
      name: 'Gemini 2.5 Pro',
      description: 'Most capable, higher quality',
    },
    {
      id: 'gemini-2.0-flash',
  ...
  groq: [
    {
      ...
      name: 'Llama 3.3 70B',
      description: 'Most capable, versatile (FREE)',
    },
    {
      id: 'llama-3.1-8b-instant',
      name: 'Llama 3.1 8B',
      description: 'Fast, efficient (FREE)',
    },
    {
      id: 'llama-3.2-90b-vision-preview',
      name: 'Llama 3.2 90B Vision',
      description: 'Multimodal (FREE)',
    },
    {
      id: 'mixtral-8x7b-32768',
      name: 'Mixtral 8x7B',
      description: 'MoE model, 32k context (FREE)',
    },
    {
      id: 'gemma2-9b-it',
      name: 'Gemma 2 9B',
      description: 'Google Gemma (FREE)',
    },
  ],
  deepseek: [
    {
      ...
      description: '64K output, best for large docs ($0.12/proj)',
    },
    {
      id: 'deepseek-chat',
      name: 'DeepSeek Chat',
      description: '8K output, fast & cheap ($0.06/proj)',
    },
  ],
};
...
export const PROVIDER_INFO: Record<
  ProviderType,
  { name: string; envKey: string; docsUrl: string }
> = {
  gemini: {
    name: 'Google Gemini',
